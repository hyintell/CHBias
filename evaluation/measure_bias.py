...
data_path = '../data/replace_all/'
exp_path = '../Dialolog/mea_bisa/'
...
demo = 'race' # 'orientation' # 'gender' # 'religion2' # 'race' # 'religion2
demo_1 = 'black' # 'lgbtq' # 'female' # 'muslims' # 'black' # 'black_pos'
demo_2 = 'asian' # 'straight' # 'male' # 'white' # 'white_pos'  # 'white' #'christians2'
...
print(demo_1, demo_2)
debiasing_head = 'EqualisingLoss' # 'CosineDist', 'EqualisingLoss'
pretrained_model = '../models1/race/cos_loss_grid' # 'bert_base_uncased' # 'gpt2'
    # ../models1/religion2/eq_loss_grid
